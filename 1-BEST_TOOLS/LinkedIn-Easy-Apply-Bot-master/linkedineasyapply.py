...
class LinkedinEasyApply:
            ...
            try:
                while True:
                    ...
                    if page_sleep % 5 == 0:
                        ...
                        print("Sleeping for " + str(5) + " minutes.")
                        time.sleep(5)
                        page_sleep += 1
            except:
                traceback.print_exc()
    ...
    def apply_jobs(self, location):
        ...
        try:
            ...
            # self.scroll_slow(job_results, step=50, reverse=True)

            job_list = self.browser.find_elements_by_class_name('scaffold-layout__list-container')
        except:
            raise Exception("No more jobs on this page")
