...
# access_token = "wVzR7FkkPM-aAujrNsg_CeiY6JBkk"
...
auth_token = 'nltNneeJtoZ6UmlvJW0aTYZ4'
...
def gethistoricaldata(exchange, tokenlist, starttime, endtime, interval=1):
    starttime = "2022-03-01 09:15:00"
    endtime = "2022-03-08 15:30:00"
    PARAMS = {
        'candletype': 1,
    ...
    for i in range(0, len(tickerlist)):
        ...
        try:
            ...
            if super_trend[-1]=='up' and super_trend[-3]=='down' and super_trend[-4]=='down' and super_trend[-5]=='down' and super_trend[-6]=='down':
                ...
                order = alice.place_order(exchange='NSE',
...
def run():
    ...
    end_time = int(22) * 60 + int(10)  # do not place fresh order
    stop_time = int(22) * 60 + int(15)  # square off all open positions
