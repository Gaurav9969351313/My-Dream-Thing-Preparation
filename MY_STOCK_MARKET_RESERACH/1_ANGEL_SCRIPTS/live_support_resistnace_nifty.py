...
# def (skk):         return "\033[91m {}\033[00m".format(skk)
# def (skk):       return "\033[92m {}\033[00m".format(skk)
# def (skk):      return "\033[93m {}\033[00m".format(skk)
# def (skk): return "\033[94m {}\033[00m".format(skk)
# def (skk):      return "\033[95m {}\033[00m".format(skk)
# def (skk):        return "\033[96m {}\033[00m".format(skk)
# def (skk):   return "\033[97m {}\033[00m".format(skk)
# def (skk):       return "\033[98m {}\033[00m".format(skk)
# def (skk):        return "\033[1m {}\033[0m".format(skk)
        ...
        if item["expiryDate"] == currExpiryDate:
            if item["strikePrice"] == strike and item["strikePrice"] < start_strike+(step*num*2):
                ...
                print(data["records"]["expiryDates"][0] + " " + str(item["strikePrice"]) + 
                      ...
                      + " CP: "+ (str(item["CE"]["changeinOpenInterest"])).rjust(10," ") + "" + 
...
print((str("Major Support in Nifty:")) + str(highest_oi_CE(10,50,nf_nearest,url_nf)))
print((str("Major Resistance in Nifty:")) + str(highest_oi_PE(10,50,nf_nearest,url_nf)))
print((str("Major Support in Bank Nifty:")) + str(highest_oi_CE(10,100,bnf_nearest,url_bnf)))
print((str("Major Resistance in Bank Nifty:")) + str(highest_oi_PE(10,100,bnf_nearest,url_bnf)))