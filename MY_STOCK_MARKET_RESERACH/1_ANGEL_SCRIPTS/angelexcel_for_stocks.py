# kindly install these libraries first using cmd
# pip install xlwings
...
exchange = "NSE"
sheet = xw.Book("E:/ANGEL_SCRIPTS/angel_trade_setup.xlsx").sheets[0]
...
script_list = {
    'BANKNIFTY27OCT2241500CE-EQ': '57217',
    '20MICRONS-EQ': '16921',
    '21STCENMGM-EQ': '4',
    '3IINFOLTD-EQ': '6232',
    '3MINDIA-EQ': '474',
...
def sendData(message):
    ...
    ltp = message[0]["ltp"]
    token = message[0]["tk"]
    script_name, high, low, openx = name(token, ltp)
    volume = message[0]["v"]
    ...
    sheet.range(f"F{cell_no}").value = openx
